/**
 * @fileoverview (Copied from link at 20201001) disallow assignments that can lead to race conditions due to usage of `await` or `yield`
 * @author Teddy Katz
 * @author Toru Nagashima
 * Ref: {@link https://github.com/eslint/eslint/blob/master/lib/rules/require-atomic-updates.js}
 */
"use strict"
...
module.exports = {
    ...
    create(context) {
        ...
        const ignoreStrs = context.options[0]
        const hasIgnoreStrs = ignoreStrs && ignoreStrs.length >= 0
        ...
        return {
            ...
            Identifier(node) {
                // Ref: @link {https://github.com/koajs/koa/issues/1351} !!!
                if(hasIgnoreStrs && ignoreStrs.includes(node.name)) return
