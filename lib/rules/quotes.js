...
module.exports = {
  ...
  create(context) {
    ...
    const avoidEscape = options && options.avoidEscape === true
    const ignoreImport = options && options.ignoreImport === true
    /**
    ...
    return {
      Literal(node) {
        ...
        if(ignoreImport && parent && (
          (parent.type == "ImportDeclaration") ||
          (parent.callee && parent.callee.type == "Import") ||
