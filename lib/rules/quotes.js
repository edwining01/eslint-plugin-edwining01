/**
 * @fileoverview (Copied from link at 20200911) A rule to choose between single and double quote marks
 * @author Matt DuVall <http://www.mattduvall.com/>, Brandon Payton
 * @link https://github.com/eslint/eslint/blob/master/lib/rules/quotes.js
 */
    ...
    create(context) {
        ...
        return {
            ...
            Literal(node) {
                ...
                if(parent && parent.type == "ImportExpression") { // dynamic import
                  return
                } else if(parent && parent.type == "CallExpression" &&
                  parent.callee.name == "require") { // dynamic require
                  return
                }
