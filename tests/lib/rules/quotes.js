 ...
 * Ref: {@link https://github.com/eslint/eslint/blob/master/lib/rules/quotes.js}
 */
"use strict"
...
ruleTester.run("quotes", rule, {
  valid: [
    ...
    // import
    { code: `import "a"`, options: ["single", { ignoreImport: true }], parserOptions: { sourceType: "module" } },
    { code: `import 'a'`, options: ["double", { ignoreImport: true }], parserOptions: { sourceType: "module" } },
    { code: `import("a")`, options: ["single", { ignoreImport: true }], parser: "babel-eslint", parserOptions: { sourceType: "module" } },
    { code: `import('a')`, options: ["double", { ignoreImport: true }], parser: "babel-eslint", parserOptions: { sourceType: "module" } },
    { code: `require("a")`, options: ["single", { ignoreImport: true }], parserOptions: { sourceType: "module" } },
    { code: `require('a')`, options: ["double", { ignoreImport: true }], parserOptions: { sourceType: "module" } },
  ],
  invalid: [
    {
      code: "var foo = 'bar';",
